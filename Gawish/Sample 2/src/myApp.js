...
var myLayer = cc.Layer.extend({
    ...
    makeStuff:function()
    {
        ...
        var buildWalls = function(){
            ...
            var walls = [   
                    //simple walls
                    new cp.SegmentShape(staticBody, cp.v(0,0), cp.v(stageSize.width,300), 0),
        ...
        box = addBox(200,100,cp.v(500,400));
        
        c1 = addCircle(30,cp.v(400,280));
        c2 = addCircle(30,cp.v(600,280));
        
        var joint1 = new cp.PivotJoint(box,c1,c1.p);
        space.addConstraint(joint1);

        var joint2 =new cp.PivotJoint(box,c2,c2.p);
