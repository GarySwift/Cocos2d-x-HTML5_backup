...
ek.Parallax = cc.ParallaxNode.extend(
{
   ...
   addRandomLoopSprites:function(images, layerRatio, zDepth, numClones){
    ...
    addToHorizontalStack:function(objectStack, layerLength){
        ...
        //cc.log("typeof "+layerObjectLength);
        //cc.log("layerObjectStack "+layerObjectStack+" layerObjectLength "+layerObjectLength);
