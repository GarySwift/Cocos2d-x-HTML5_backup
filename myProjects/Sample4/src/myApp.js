var MyApp = cc.LayerColor.extend(
{
    ...
    init:function()
    {
        ...
        this.parallaxContainer = new cc.Layer();


        this.parallaxContainer.addChild(this.parallaxEffectNode);
        console.log("this.parallaxEffectNode ",this.parallaxEffectNode);
        ...
        //this.parallaxEffectNode.setPositionX(.001);
