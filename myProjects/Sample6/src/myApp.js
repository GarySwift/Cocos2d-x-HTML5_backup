...
var Joints = function() {
 ...
 // Gravity
    ...
    var motor2 = new cp.SimpleMotor( chassis , wheel2, 5 );
    ...
    _motorRear = motor2;
     ...
     space.addConstraint(new cp.DampedSpring(chassis, wheel2, cp.v( 90, 0), cp.v(0,0), 280, 340, 310));
